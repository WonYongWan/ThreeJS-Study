...
scene1.set(() => {
  ...
  scene1.controls = new OrbitControls(scene1.camera, scene1.elm);
...
scene2.set(() => {
  ...
  scene2.controls = new OrbitControls(scene2.camera, scene2.elm);
...
scene3.set(() => {
  ...
  scene3.controls = new OrbitControls(scene3.camera, scene3.elm);

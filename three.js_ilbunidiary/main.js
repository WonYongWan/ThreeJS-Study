...
const floorTexture = textureLoader.load('/images/grid.png'); // 바닥 이미지
floorTexture.wrapS = THREE.RepeatWrapping;
floorTexture.wrapT = THREE.RepeatWrapping;
floorTexture.repeat.x = 10; // 바닥 이미지 반복
floorTexture.repeat.y = 10; // 바닥 이미지 반복
...
// Camera
const camera = new THREE.OrthographicCamera( // 직교 카메라
